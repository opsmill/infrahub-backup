...
<Tabs>
<TabItem value="database-only" label="Database Only">

Restore only the Neo4j database:

```bash
infrahubops backup restore infrahub_backups/infrahub_backup_20250929_143022.tar.gz --components=database
```

</TabItem>
<TabItem value="taskmanager-only" label="Task Manager Only">

Restore only the PostgreSQL task manager:

```bash
infrahubops backup restore infrahub_backups/infrahub_backup_20250929_143022.tar.gz --components=task-manager-db
```

</TabItem>
<TabItem value="artifacts-only" label="Artifacts Only">

Restore only file artifacts:

```bash
infrahubops backup restore infrahub_backups/infrahub_backup_20250929_143022.tar.gz --components=artifacts
```
...
infrahubops backup info infrahub_backups/backup.tar.gz
...
- [Disaster recovery planning](../topics/disaster-recovery.mdx)
- [CLI command reference](../reference/commands.mdx#restore-commands)