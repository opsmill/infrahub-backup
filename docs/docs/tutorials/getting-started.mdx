...
- Linux AMD64: `infrahub-ops-linux-amd64`
- Linux ARM64: `infrahub-ops-linux-arm64`
- macOS AMD64: `infrahub-ops-darwin-amd64`
- macOS ARM64: `infrahub-ops-darwin-arm64`

Then make it executable:

```bash
chmod +x infrahub-ops-*
mv infrahub-ops-* infrahubops
```
...
- [How to schedule automated backups](../guides/schedule-backups.mdx)
- [How to clean up old backups](../guides/manage-backup-retention.mdx)
