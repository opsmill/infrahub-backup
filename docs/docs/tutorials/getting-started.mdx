---
title: Getting Started with Infrahub Operations Tools
---

import Tabs from '@theme/Tabs';
import TabItem from '@theme/TabItem';

This tutorial walks you through your first experience with the Infrahub Operations Tools, teaching you the fundamentals by creating a backup of your Infrahub instance and then restoring it. By the end of this tutorial, you'll understand the basic workflow and be confident in using `infrahub-backup` for essential maintenance tasks.
...
First, install the infrahub-backup tool. The recommended method is to build from source:
...
```bash
./bin/infrahub-backup environment detect
```
...
```bash
./bin/infrahub-backup environment list
```
...
./bin/infrahub-backup restore infrahub_backups/infrahub_backup_20250929_143022.tar.gz
```
...
Congratulations! You've completed your first backup and restore cycle with the Infrahub Operations Tools. You now know how to:
