...
> **⚠️ One status line superseded (2026-08-07).** Where the remaining Deliverable-A work is listed as including an "upstream PR", that item is dropped — the integration is not upstreamed. Remaining integration work is tracked as 006 workstream B. See [SUPERSEDED-BY-006.md](./SUPERSEDED-BY-006.md).
